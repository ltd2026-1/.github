...
<p align="center">
  <strong>🚀 Enterprise SaaS Platform for Business Intelligence, Predictive Analytics &amp; AI-Powered Decision Making</strong>
</p>

<p align="center">
  Intelligent business analytics platform with generative AI, predictive analysis and real-time dashboards for sales teams.
</p>
...
<p align="center">
  ...
  <a href="../public/manifest.json"><img src="https://img.shields.io/badge/PWA-Enabled-5A0FC8?style=for-the-badge&logo=pwa&logoColor=white" alt="PWA" /></a>&nbsp;
  <a href="../messages/"><img src="https://img.shields.io/badge/i18n-3_Locales-7c3aed?style=for-the-badge" alt="i18n" /></a>
</p>

<p align="center">
  <a href="https://bizanalyticsai.com.br"><img src="https://img.shields.io/badge/🌐_Website-bizanalyticsai.com.br-7c3aed?style=flat-square" alt="Website" /></a>&nbsp;
  <a href="https://bizanalyticsai.com.br/dashboard"><img src="https://img.shields.io/badge/📊_Dashboard-Access-10b981?style=flat-square" alt="Dashboard" /></a>&nbsp;
  <a href="https://bizanalyticsai.com.br/docs"><img src="https://img.shields.io/badge/📖_Docs-Documentation-3b82f6?style=flat-square" alt="Docs" /></a>&nbsp;
  <a href="https://bizanalyticsai.com.br/suporte"><img src="https://img.shields.io/badge/💬_Support-Contact-f59e0b?style=flat-square" alt="Support" /></a>
</p>
...
|---|---|---|
| **Multilingual Blog** | Admin panel with pt-BR / en-US / es-ES tabs for post creation | Apr 2026 |
| **Admin Translations** | Visual i18n key manager with CSV export and completion status | Apr 2026 |
| **Video Tutorials** | Admin CRUD + video player (YouTube/embed/mp4) with modal at `/tutoriais` + thumbnail preview in cards | Apr 2026 |
| **eBook Library** | Admin PDF CRUD + gated download at `/ebooks` | Apr 2026 |
| **ContainerScroll Hero** | 3D parallax animation in "Our Platform" section (framer-motion) | Apr 2026 |
| **Admin Shader Banner** | Admin sidebar with animated banner via `@paper-design/shaders-react` | Apr 2026 |
| **Grouped Admin Nav** | Admin navigation reorganized into 6 semantic groups with active gradient | Apr 2026 |
| **Social Links Footer** | Real links (X, LinkedIn, YouTube, Instagram) with brand hover colors | Apr 2026 |
| **Session Persistence** | `AUTH_USER_KEY` shared between `/dashboard`, `/admin`, and `/alunos` portals | Apr 2026 |
...
- **Pixel Office** — multi-floor virtual office with animated pixel art agents
...
Built on **Supabase (PostgreSQL)** with Row Level Security enabled on all tables.
...
Every user can independently customize the look and feel of their dashboard. Settings are stored in `user_dashboard_settings` and are **fully isolated per account**.

| Tab | Options |
|---|---|
| **Identity** | Platform name (replaces "BizAnalyticsAI"), logo URL |
| **Colors** | Accent color, primary color, background, sidebar, cards, text |
| **Navigation** | Sidebar item order (↑↓), show/hide individual items |
...
| Title | Topics |
|---|---|
| **Churn & LTV Analysis** | Churn modeling, LTV calculation, retention playbooks, cohort analysis |
| **Market Analysis: Practical Guide** | TAM/SAM/SOM, Porter's Five Forces, PESTEL, competitive mapping |
| **KPIs That Matter for Startups** | Key metrics by stage, OKR framework, tracking implementation |
| **Monte Carlo for Entrepreneurs** | Financial simulation theory, uncertainty modeling, scenario planning |
| **AI Trends 2025** | AI landscape, generative AI, business applications, strategic roadmap |
| **Financial Viability Simplified** | Break-even, payback, unit economics, SaaS financial modeling |
| **Complete Business Plan Guide 2025** | Full plan methodology: executive summary through financial projections |
...
4. Add your Vercel domain to Redirect URLs in **Authentication → URL Configuration**
...
├── README-traducao/        # README translations
...
**Built with precision by LTD — Laboratório de Tecnologia e Desenvolvimento.**
